namespace Assignment
{
    public class AssignmentConfig
    {
        ...
        /// </summary>  
        public const string AssignmentName = "Assignment 03";

        /// <summary>
        /// Description of the assignment.
        /// </summary>
        public const string AssignmentDescription = "Introduction to OOP - class, polymorphism, class member, class method, access modifier: private, protected, public, virtual and override method";

        public const string AssignmentResourceID = "bu.2025.sem-1.gi262.as03";
